    ...
    <section id="product" className="max-container w-full flex flex-col">
        <div className="flex flex-col">
            ...
            <div className="pt-2 justify-between items-center gap-5 flex flex-row">
                <p className="max-md:text-2xl text-3xl flex-1 mt-2 font-bold font-palanquin">Best Selling Cards</p>
                <a className="px-8 py-3 text-lg font-semibold border hover-2 rounded cursor-pointer border-gray-800">View All</a>
            </div>
        </div>
        <Line/>
    </section>
